      ...
      <View style={styles.container}>
        <TextInput
          ...
          {this.state.intialSecure ?
            ...
            onPress={() => {
            this.setState({isShow: !this.state.isShow, secureTextEntry: !this.state.secureTextEntry});
            }}>
              <Image style={styles.icon} source={this.state.isShow? IC_HIDE : IC_SHOW}></Image>
