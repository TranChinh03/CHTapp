...
import { IMG_AUTHBACKGROUND, IMG_COURSEBACKGROUND, IMG_CPP, IMG_CPPBACKGROUND, IMG_VIDEO } from '../src/assets/img'
...
import { IC_DOWNLOAD, IC_FAVORITE, IC_FILLEDFAVORITE, IC_GLOBAL, IC_INFORMATION, IC_NEXT } from '../src/assets/icons'
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView>
            <View style={styles.container1}>
                <ImageBackground style={styles.image} source={IMG_VIDEO} resizeMode='contain'/>
            </View>
            ...
            <View style={styles.container2}>
                    ...
                    <View style={styles.infoContainer}>
                        ...
                        <Text style={[styles.infoText, {marginLeft: scale(20, 'w')}]}>Times: 30 mins</Text>
                        <View style={styles.numOfView}>
                            <Text style={styles.infoText}>320</Text>
                            <Image style={{marginLeft: scale(5, 'w')}} source={IC_VIEW}/>
                        </View>
                    </View>
                    <Text style={styles.description}>This is the first lesson in the course C++ for beginners. The goal of this lesson is to help you get familiar with CodeLearn and setting up the C++ programming environment.</Text>
                    ...
                    <View style={styles.evaluataionBar}>
                        <CusRatingBar/>
                        <TouchableOpacity style={styles.iconFavor} onPress={() => {this.setState({addFavor : !this.state.addFavor})}}>
                            <Image  source={this.state.addFavor === true ? IC_FILLEDFAVORITE : IC_FAVORITE}></Image>
                        </TouchableOpacity>
                    </View>
            </View>
        </ScrollView>
